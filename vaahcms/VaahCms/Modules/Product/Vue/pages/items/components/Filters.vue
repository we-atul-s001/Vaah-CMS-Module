            ...
            <Panel class="is-small">
                ...
                <template #icons>
                    ...
                    <div class="p-inputgroup">
                        ...
                        <Button data-testid="items-hide-filter"
                                class="p-button-sm"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-none"
                                 inputId="sort-none"
                                 data-testid="items-filters-sort-none"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-ascending"
                                 ...
                                 data-testid="items-filters-sort-ascending"
                                 value="updated_at"
                                 v-model="store.query.filter.sort" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="sort-descending"
                                 ...
                                 data-testid="items-filters-sort-descending"
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-all"
                                 inputId="active-all"
                                 value="null"
                                 data-testid="items-filters-active-all"
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-true"
                                 inputId="active-true"
                                 data-testid="items-filters-active-true"
                                 value="true"
                                 v-model="store.query.filter.is_active" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="active-false"
                                 ...
                                 data-testid="items-filters-active-false"
                                 value="false"
                                 v-model="store.query.filter.is_active" />
            ...
            <VhFieldVertical >
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-exclude"
                                 ...
                                 data-testid="items-filters-trashed-exclude"
                                 value=""
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-include"
                                 ...
                                 data-testid="items-filters-trashed-include"
                                 value="include"
                                 v-model="store.query.filter.trashed" />
                ...
                <div class="field-radiobutton">
                    <RadioButton name="trashed-only"
                                 ...
                                 data-testid="items-filters-trashed-only"
                                 value="only"
                                 v-model="store.query.filter.trashed" />
